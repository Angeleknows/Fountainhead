...
# Final Thoughts
>It’s been incredibly insightful to see how different perspectives, including my own, have shaped my understanding of what works and what doesn’t in the story. Feedback, such as adding personal stories or refining visualizations, has helped me recognize the potential to make the narrative more impactful and engaging. It’s satisfying to realize how small changes can significantly influence how the story is received.
>The challenges, however, have been substantial. One of the toughest parts has been deciding what data to work with and finding a clear focus for the story. In Part 1, I had too much data to sift through, and I began to feel overwhelmed, as though I needed to scrape through each dataset to find the key points to support my analysis. At times, I felt pulled in multiple directions and unsure if the narrative was as clear as it could be. Ultimately, I decided to focus on comparing cities and layering in how their Latino populations differ from the percentage of funding allocated to Latino artists in those cities.
>Balancing the authenticity of the data with telling a clear story that is personally important to me has been challenging, but it’s also been a necessary learning experience. I’ve come to understand that refining the focus is as much about deciding what to leave out as it is about what to include. In the end, I’m confident that this process will result in a stronger, more cohesive final version.
